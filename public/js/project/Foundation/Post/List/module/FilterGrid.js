...
define([
  ...
  'project/Foundation/Post/List/meta/grid',
  'project/Foundation/Post/List/meta/filter'
], function(TypeFactory, FilterGridModule, gridMeta, filterMeta) {

  var PostFilterGridModule;

  /*过滤表格模块*/
  PostFilterGridModule = Q.Class.define(FilterGridModule, {

    type: 'PostFilterGridModule',
